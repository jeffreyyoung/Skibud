...
class NoMoreCards extends Component {
  ...
  render() {
    return (
      <View>
        <Text style={styles.noMoreCardsText}>Looking for more skiiers...</Text>
      </View>
    )
  }
}
...
class SwipeCards extends Component {
  ...
  componentWillReceiveProps(nextProps){
    if(nextProps.cards && nextProps.cards.length > 0 && (this.props.cards.length === 0 || nextProps.cards[0]._id !== this.props.cards[0]._id)){
		this._animateEntrance();
		this.setState({
  ...
  render() {
	...
	console.log('theres a card', this.state.card);
        return (
