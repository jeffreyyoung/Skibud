...
class SwipeCardsContainer extends Component {
  constructor(props) {
    super(props);
    ...
    this.swipeRight = _.throttle(this.swipeRight, 1500);
    this.swipeLeft = _.throttle(this.swipeLeft, 1500);
  }
  ...
  componentWillReceiveProps(nextProps){
    if(!_.isEqual(this.props.cards, nextProps.cards) && nextProps.cards.length > 0){
      this.setState({
...
SwipeCardsContainer.defaultProps = {
    loop: false,
    showYup: true,
    showNope: true,
